...
public class Day07 {
	...
	public int solvePuzzle1() {
		...
		// at each node, if its total size is <=10,000, then add to totalTotalSizes
...
class Directory {
	...
	public Directory getChildDirectoryNamed(String name) {
		for (Directory d : directories) {
	...
	public boolean containsChildDirectoryNamed(String name) {
		for (Directory d : directories) {
			if (d.name.equals(name)) {
				return true;
			}
